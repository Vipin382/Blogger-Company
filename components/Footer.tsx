            ...
            <div className="text-center">
              ...
              <ul>
                <li className="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <Link href="/blog/food?type=entertainment">
                    Entertainment
                  </Link>
                </li>
                <li className="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <Link href="/blog/all?type=general">General</Link>
                </li>
                <li className="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <Link href="/blog/sport?type=sports">Sport</Link>
                </li>
                <li className="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <Link href="/blog/healthcare?type=health">Health</Link>
                </li>
              </ul>
            </div>
          </li>
